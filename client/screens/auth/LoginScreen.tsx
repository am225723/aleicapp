...
const LINE_ART_MASK = require("../../assets/line-art-mask.png");
const ALEIC_LOGO = require("../../assets/aleiclogo.png");
...
export default function LoginScreen() {
  ...
  return (
    ...
    >
      ...
      <MaskedView
        style={styles.backgroundArtContainer}
        maskElement={
          <Image
            source={LINE_ART_MASK}
